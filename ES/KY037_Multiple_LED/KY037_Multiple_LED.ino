...
#define LED_4 5
#define LED_5 6
#define sensorPin A0 // Analog input pin that the Sensor is
attached to
...
Serial.begin(9600);// initialize serial communications at
9600 bps:
}
void loop() {
...
if (sensorValue > 555 )
 ...
 if (sensorValue > 564 )
 ledPin5Status = 1;
if (ledPin1Status == 1 || ledPin2Status == 1 ||
ledPin3Status == 1 || ledPin4Status == 1 || ledPin5Status ==
1)
{
