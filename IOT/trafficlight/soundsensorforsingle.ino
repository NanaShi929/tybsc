...
void loop() {
 ...
 Serial.println(angSenValue); // Debugging: Print the sensor value to the serial monitor
Serial.println(digSenValue); // Debugging: Print the sensor value to the serial monitor
 if(digSenValue==1){
 if(LEDStatus==false){
 LEDStatus=true;
